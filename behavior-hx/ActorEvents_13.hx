	...
	override public function init()
	{
		...
		addCollisionListener(actor, function(event:Collision, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && sameAsAny(getActorType(0), event.otherActor.getType(),event.otherActor.getGroup()))
			{
				...
				Engine.engine.setGameAttribute("levels_completed", (Engine.engine.getGameAttribute("levels_completed") + 1));
				if((Engine.engine.getGameAttribute("levels_completed") > Engine.engine.getGameAttribute("highest_levels_completed")))
				{
					Engine.engine.setGameAttribute("highest_levels_completed", Engine.engine.getGameAttribute("levels_completed"));
				}
